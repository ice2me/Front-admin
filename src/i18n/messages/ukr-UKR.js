...
export default {
	[LOCALES.UKR]: {
		...
		// ******************************************************** HOME
		createAnOnlineShowcaseForYourStore: 'Створи онлайн вітрину',
		createAnOnlineShowcaseForYourStore1: 'для свого магазину',
		getStarted: 'Розпочати',
		startDoing: 'Почніть зараз займатися своєю справою!',
		createYourOnlineStoreEasilyStartEarningToday: 'Створи легко онлайн-магазин  та активуй свій бізнес вже сьогодні.',
		learnMore: 'Дізнатися більше',
		tiredOfNotDoing: 'Чому ваш бізнес',
		whatImportant: "не розвивається?",
		...
		theresBetterWay: 'Є найкращий варіант змінити це за допомогою нашої онлайн платформи Theke.',
		...
		step1: 'Крок 1',
		createCategoryFillWithProductCards: 'Створіть категорію та заповніть її картками товарів вашого магазину.',
		step2: 'Крок 2',
		sendLinkYourStoreYourCustomersConvenientWay: 'Надсилайте клієнтам посилання на ваш магазин будь-яким зручним способом.',
		step3: 'Крок 3',
