...
export default {
	[LOCALES.UKR]: {
		...
		createAnOnlineShowcaseForYourStore1: 'твого магазину',
		getStarted: 'Розпочати',
		startDoing: 'Просто та швидко',
		createYourOnlineStoreEasilyStartEarningToday: 'Створи онлайн-магазин  та активуй свій бізнес в інтернеті',
		...
		theresBetterWay: 'Theke  найкращій варіант онлайн платформи для вашого бізнесу',
		...
		fastCommunicationWithClients: 'Постійнапідтримкатехнічноїслужби',
		seeHowItWorks: 'Дивись, як це працює',
		howItWorks: 'Як це працює?',
		step1: 'Крок 1',
		createCategoryFillWithProductCards: 'Створюємо ваш магазин та наповнюємо вашими товарами по категоріям',
		step2: 'Крок 2',
