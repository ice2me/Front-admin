...
export default {
	[LOCALES.UKR]: {
		...
		startDoing: 'Просто та швидко створіть онлайн-вітрину',
		createYourOnlineStoreEasilyStartEarningToday: ' та активуйте ваш бізнес в інтернеті',
		...
		theresBetterWay: 'Theke - найкращий варіант онлайн-платформи',
