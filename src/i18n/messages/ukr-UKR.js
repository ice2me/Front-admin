...
export default {
	[LOCALES.UKR]: {
		...
		// ******************************************************** HOME
		createAnOnlineShowcaseForYourStore: 'Унiверсальна \n Онлайн-вітрина',
		createAnOnlineShowcaseForYourStore1: 'Вашого магазину',
		getStarted: 'Розпочати',
		startDoing: 'Абсолютно новий погляд з максимально',
		createYourOnlineStoreEasilyStartEarningToday: ' простим управлінням магазину',
		learnMore: 'Дізнатися більше',
		tiredOfNotDoing: 'Чому Theke сприятиме',
		whatImportant: "розвитку вашого магазину?",
		yourBusinessNotOnline: 'Сучасна інтернет-сторінка',
		yourCustomerBaseIsNotGrowing: 'Мінімум часу на заповнення карток товару',
		youCannotQuicklyPresentYourProductClient: 'Клієнтська база зростатиме',
		youSpendLotTimeTakingOrdersFromEachClient: 'Опрацювання займатиме мінімум часу',
		theresBetterWay: 'Theke-найкращий варіант CRM платформи',
		easeOfUse: 'Ваші клієнти бачать тільки Ваші товари',
		speed: 'Простота наповнення Вашої сторінки',
		...
		sendLinkYourStoreYourCustomersConvenientWay: 'Створіть категорії, заповніть картки товарів та розмістіть посилання для Ваших клієнтів у месенджерах',
		theClientClicksOnYourLinkAndMakesOrderYourStore: 'Отримуйте та надсилайте замовлення покупцям з усієї України та за кордон',
		...
		firstMonthIsFree: 'Перший місяць Безкоштовно !!!',
