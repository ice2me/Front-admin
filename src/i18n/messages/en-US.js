...
export default {
	[LOCALES.EN]: {
		...
		// ******************************************************** HOME
		createAnOnlineShowcaseForYourStore: 'Create an online showcase',
		createAnOnlineShowcaseForYourStore1: 'for your store',
		getStarted: 'Get Started',
		startDoing: 'Start doing your business now!',
		createYourOnlineStoreEasilyStartEarningToday: 'Create easily online store and activate your business today.',
		learnMore: 'Learn more',
		tiredOfNotDoing: 'Why is your business',
		whatImportant: "not growing?",
		...
		theresBetterWay: 'There is a better way to change this with our Theke online platform',
