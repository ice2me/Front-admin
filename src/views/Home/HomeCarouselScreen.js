			...
			<div className='home-carousel_wrapper'>
				...
				<div className='home-carousel_content'>
					<div className='home-carousel_content-wrapper'>
						...
						<div className='home-carousel_content-wrapper_content'>
							<p className='home-carousel_content-wrapper_content-text'>
								На платформі Theke я запустив свій перший інтернет-магазин. Досвіду користування такими речами раінше не мав. Трохи переживав з цього приводу. щоАле недолік мого досвіду компенсували співробітники платформи, надаючи дуже прості і водночас корисні консультації. Результат перевищив мої очікування, тому що інші компанії бюджет вимагали глибші знання онлайн-платформ.
							</p >
						</div >
					</div >
				</div >
