...
import { getRegistrationSchema } from "../../utils/validation/yupLoginEmail"

const RegistrationMobUser = () => {
	...
	return (
		<div className='loginMob-body'>
			...
			<div className='loginMob-body_center p-2'>
				...
				>
					{({
						...
						<Form
							className='registrationShop-form align-items-center'
							onSubmit={handleSubmit}
						>
...
export default RegistrationMobUser